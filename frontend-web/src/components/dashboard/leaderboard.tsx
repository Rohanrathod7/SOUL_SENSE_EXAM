            ...
            <LayoutGroup>
              {contributors.map((contributor, index) => (
                ...
                >
                  ...
                  <Avatar className="h-16 w-16 ring-4 ring-offset-4 ring-offset-slate-50 dark:ring-offset-slate-950 ring-slate-100 dark:ring-transparent group-hover/item:ring-blue-500/50 transition-all duration-500">
                  ...
                  <div className="mt-4 text-center w-full flex flex-col items-center gap-1">
                    <p className="text-sm font-black tracking-tight leading-none mb-1 capitalize truncate max-w-full text-slate-900 dark:text-white">
                      {contributor.login}
                    </p>
                    <div className="flex flex-col items-center gap-1">
                      <a
                        ...
                        className="text-[10px] uppercase font-black text-slate-400 hover:text-blue-500 tracking-widest transition-colors flex items-center gap-1 border-b border-transparent hover:border-blue-500/20"
                      >
                        GitHub Profile
                      </a>
                    </div>
                  ...
                  <div className="mt-4 px-3 py-1 rounded-full bg-blue-50 dark:bg-blue-500/10 text-blue-600 dark:text-blue-400 text-[10px] font-black uppercase tracking-tighter">
