    ...
    <Card className="col-span-full lg:col-span-4 bg-white/60 dark:bg-slate-900/60 backdrop-blur-xl border-slate-200 dark:border-white/5 shadow-xl rounded-3xl overflow-hidden group relative transition-all duration-300">
      <CardHeader className="flex flex-row items-center justify-between pb-2">
        ...
        <div className="flex items-center gap-2">
          <div className="px-2 py-1 rounded-full bg-blue-50 dark:bg-blue-500/10 border border-blue-100 dark:border-blue-500/20 text-[10px] font-black text-blue-600 dark:text-blue-400 flex items-center gap-1 uppercase">
      ...
      <div className="px-6 py-2 border-y border-slate-100 dark:border-white/5 bg-blue-50/30 dark:bg-blue-900/10">
        <p className="text-[10px] leading-relaxed text-slate-600 dark:text-slate-400 font-medium italic">
          <span className="text-blue-600 dark:text-blue-400 font-bold uppercase tracking-tighter mr-2">
            Why this exists:
          </span>
      ...
      <CardContent className="p-0 relative" ref={containerRef}>
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,_white,_transparent)] dark:bg-[radial-gradient(circle_at_center,_rgba(255,255,255,0.05),_transparent)] pointer-events-none opacity-50" />
        ...
        {graphData.nodes.length > 0 ? (
          <ForceGraph2D
            ...
            backgroundColor="rgba(0,0,0,0)" // Transparent for glass effect
        ...
        <div className="absolute bottom-4 right-6 text-[10px] font-bold text-slate-400 dark:text-slate-600 uppercase tracking-tighter">
